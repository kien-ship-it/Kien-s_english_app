            ...
            Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      margin: const EdgeInsets.only(left: 30, right: 30, bottom: 45, top: 25),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const SizedBox( // Changed from VerticalDivider
                          ...
                          IconButton(
                            icon: const Icon(Icons.flip, color: Colors.black, size: 30,),
                            onPressed: () {
                          ...
                          IconButton(
                            icon: const Icon(Icons.arrow_forward, color: Colors.red, size: 30,),
                            onPressed: () {
